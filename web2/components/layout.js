    ...
    <div className="container mx-auto px-4">
		<nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
			<div className="flex items-center flex-shrink-0 text-white mr-6">
				...
				<span className="font-semibold text-xl tracking-tight">Aves</span>
			</div>
			...
			<div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
				...
				<a href="/matches" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
					Matches
				</a>
				<a href="/players" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
					Players
				</a>
				</div>
				<div>
